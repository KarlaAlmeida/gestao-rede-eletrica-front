...
const AccessDeniedContent = () => {
    ...
    return (
        <div className="flex flex-column align-items-center justify-content-center h-full py-8">
            <div className="flex flex-column align-items-center justify-content-center">
                ...
                >
                    <div className="w-full surface-card py-8 px-5 sm:px-8 flex flex-column align-items-center" style={{ borderRadius: '53px' }}>
                        ...
                        <div className="text-600 mb-5">Você não tem permissão para acessar esta página.</div>
                        <Button icon="pi pi-arrow-left" label="Voltar para o Dashboard" text onClick={() => router.push('/')} />
                    </div>
                </div>
            </div>
        </div>
